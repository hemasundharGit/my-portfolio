...
export default function ContactPage({params: {locale}}: {params: {locale: string}}) {
  ...
  return (
    <div className="container py-16 md:py-24 flex items-center justify-center min-h-screen">
      <Card className="w-full max-w-lg">
        <CardHeader>
          <CardTitle className="text-center font-headline text-3xl md:text-4xl font-bold">{t('title')}</CardTitle>
        </CardHeader>
